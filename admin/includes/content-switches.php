...
class AIWA_Content_Switches{
    ...
    public function endingprompt()
    {
        ...
        $first_person_name="";
        $second_person_name="";
        if (isset($_POST['first-person-name'])){
            $first_person_name = isset($_POST['first-person-name']) && !empty($_POST['first-person-name']) ? sanitize_text_field($_POST['first-person-name']) : 'Jhon';
        }
        if (isset($_POST['second-person-name'])){
            $second_person_name = isset($_POST['second-person-name']) && !empty($_POST['second-person-name']) ? sanitize_text_field($_POST['second-person-name']) : 'Doe';
        }
